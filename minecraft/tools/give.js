...
function give() {
    ...
    if (true) {
        ...
        if (true) {
            ...
            var selection_area = value('input_selection_area').toLowerCase()
    ...
    if (true) {
        ...
        if (true) {
            ...
            if (i_lore) {
                ...
                i_lore = i_lore.split('\n');
                nbt.display.Lore = []; //                            rmv [ & ]       split at \",\"  //to   \"","\"     
                nbt.display.Lore[0] = JSON.stringify(i_lore).replace(/^\[|\]$/g, '').split('\\",\\"')//, '\\"\",\"\\"');
            }
